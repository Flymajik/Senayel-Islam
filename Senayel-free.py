        ...
        \_|  \\      // | \_/
         ...
         @@/  |=\  \  |
            ...
            (((~) __(_/   |
                 ...
                 '------'                               
\x1b[92;1m===================================>\x1b[92;1m
\x1b[93;1m Author       \x1b[92;1m=>      \x1b[93;1mDip islam
\x1b[93;1m Whatsapp     \x1b[92;1m=>      \x1b[93;1m+8801914400137
\x1b[93;1m Facebook       \x1b[92;1m=>      \x1b[93;1mSenayel Islam
\x1b[92;1m===================================>\x1b[92;1m
"""%(h))
...
def menu(): #Bilo
	...
	if farhan in ['1','01']:
		...
		os.system("xdg-open https://youtube.com/channel/UCsShEt85CBjjuorka7rFMNA)
		exit()
	else:
		os.system("https://youtube.com/channel/UCsShEt85CBjjuorka7rFMNA)
		exit()
...
def crack2(idf,pwv):
	...
	fff = '%'
	print('\r%s [Dip] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
